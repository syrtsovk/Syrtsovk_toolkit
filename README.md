...
| `humanvoice` | Редактор живого русского: находит и убирает следы нейросети (канцелярит, вода, машинные шаблоны, типографика) и возвращает тексту человеческий голос. Два режима — диагностика (пахнет ли ИИ и чем) и правка. Смотрит на текст как на 4 слоя следов, не выдумывает факты, не переусердствует. | [skills/humanvoice](skills/humanvoice/) |
