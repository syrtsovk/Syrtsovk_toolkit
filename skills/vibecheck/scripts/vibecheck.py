...
IMPACT_TITLE = {
    ...
    "downtime": "Ляжет или будет тормозить",
...
IMPACT_LEAD = {
    ...
    "downtime": "Из-за этого приложение встаёт под нагрузкой или отвечает медленно.",
...
def build_report(findings: list[dict], root: Path, scanned: dict) -> str:
    ...
    lines += [
        ...
        "",
        "Это поиск известных ошибок, а не проверка на проникновение и не замер скорости. "
